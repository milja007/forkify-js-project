...
const createRecipeObject = function (data) {
  ...
  return {
    ...
    //conditionaally added property to the object
...
export const loadRecipe = async function (id) {
  try {
    ...
    if (state.bookMarked.some(bm => bm.id === id))
...
export const getSearchResultsPage = function (page = state.search.page) {
  ...
  const start = (page - 1) * state.search.resultsPerPage; //0;-napravili u state objektu u model.js resultsperpage property = 10;
